  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragActive && 'scale-[1.02] border-blue-500 bg-blue-50/50 ring-4 ring-blue-500/10',
    ...
    >
      ...
      <div className="absolute -left-20 -top-20 h-64 w-64 rounded-full bg-gradient-to-br from-purple-50 to-blue-50 blur-3xl transition-opacity duration-700 opacity-0 group-hover:opacity-100" />
      <div className="absolute -right-20 -bottom-20 h-64 w-64 rounded-full bg-gradient-to-tl from-blue-50 to-indigo-50 blur-3xl transition-opacity duration-700 opacity-0 group-hover:opacity-100" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-3 rounded-full border border-zinc-100 bg-zinc-50/80 px-4 py-1.5 transition-all duration-300 group-hover:border-zinc-200 group-hover:bg-white">
          ...
          <span className="text-xs font-medium text-zinc-500">CSV Supported</span>
